...
* Fixed randomly ending into prison.
...
* Fixed vendors not switching correctly.
...
* Added a watch
* Fixed mouse sensitivity slider (issue [#279](https://github.com/loiste-interactive/Open-Sewer-Issues/issues/279))
...
* Fixed renting
* Fixed renovation UI bugs (issue [#208](https://github.com/loiste-interactive/Open-Sewer-Issues/issues/208))
...
* Fixed VSync not displaying correctly (issue [#226](https://github.com/loiste-interactive/Open-Sewer-Issues/issues/2226))
...
* Fixed interface flash (issue [#216](https://github.com/loiste-interactive/Open-Sewer-Issues/issues/147))

## general

* Older saves can't be loaded anymore (without editing them) (issue [#211](https://github.com/loiste-interactive/Open-Sewer-Issues/issues/211))
...
* Added yard clearing option to the tenement.
...
* Removed machines having empty bottle in their inventory.
